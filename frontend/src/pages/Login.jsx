          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
            ...
            {isError && (
              <div className="flex items-center gap-2.5 p-3 rounded-lg bg-rose-50 border border-rose-200/80 text-rose-700 text-sm animate-in fade-in duration-200">
                ...
                <span>{message || "Authentication failed. Please check your credentials."}</span>
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-xl shadow-sm shadow-blue-600/20 transition-all active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100 mt-2"
            >
              {isLoading ? (
                <>
